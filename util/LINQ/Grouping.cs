    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            IEnumerable<IGrouping<bool, Customer>> groupQuery = customers
                .GroupBy(c => c.Price >= 1000); //false = small spenders true = big spenders
            ...
            foreach (IGrouping<bool, Customer> stateGroup in groupQuery)
            {
                ...
                {
                    Console.WriteLine("  {0} {1}: {2:C}", c.First, c.Last, c.Price); //then details
                }
            }
