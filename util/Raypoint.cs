...
namespace ExampleApp {
	public class RayPoint : Object {
		...
		public static RayPoint Parse(string value) {
			...
			var cleanedString = Regex.Replace(value, "[^0-9,-]", ""); //remove everything but 0-9 comma or - sign
			string[] comma = { "," };
			...
			List<int> numbers = new List<int>(Array.ConvertAll(splitValues, int.Parse)); //turn array of str into int
